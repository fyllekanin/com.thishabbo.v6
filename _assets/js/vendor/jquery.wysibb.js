...
(function($) {
	'use strict';
	$.wysibb = function(txtArea, settings, name) {
		$(txtArea).data("wbb",this);


    this.name = name;
    //this.callbackOnPost = scallbackOnPost;
...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,|,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,atitle,|,smilebox,|,removeFormat,|",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				img : {
						...
						tabs: [
							{
								...
								input: [
									...
									{param: "WIDTH",title:'Width', type: "div"},
									{param: "HEIGHT",title:'Height', type: "div"},
								]
							}
						],
					...
					transform : {
						...
						'<div id="quote_post_id-{postid}" class="quotePost"><small>Originally Posted by <b>{username}</b></small><br /><br />{content}</div>':"[quotepost={postid};{username}]{content}[/quotepost]"
					}
				},
				bullist : {
				...
				quote : {
					...
					transform : {
						...
						'<img src="{SRC}" align="right" />':"[imgr]{SRC}[/imgr]",
						'<img src="{SRC}" align="left" />':"[imgl]{SRC}[/imgl]"
					}
				},
				code : {
					title: CURLANG.code,
				...
				fontfamily: {
					...
					options: [
						...
						{title: "Book Antiqua",exvalue: "Book Antiqua"},
			...
			smileList: [
				{title:CURLANG.sm1, img: '<img src="/_assets/img/emoticons/angry.png" alt="angry" class="post_emoji" />', bbcode:":angry:"},
				{title:CURLANG.sm2, img: '<img src="/_assets/img/emoticons/blush.png" alt="blush" class="post_emoji" />', bbcode:":blush:"},
				{title:CURLANG.sm3, img: '<img src="/_assets/img/emoticons/bro_fist.png" class="sm">', bbcode:":bro_fist:"},
				{title:CURLANG.sm4, img: '<img src="/_assets/img/emoticons/clap.png" class="sm">', bbcode:":clap:"},
				{title:CURLANG.sm5, img: '<img src="/_assets/img/emoticons/cry.png" class="sm">', bbcode:";("},
				{title:CURLANG.sm6, img: '<img src="/_assets/img/emoticons/grandma.png" class="sm">', bbcode:":cry:"},
				{title:CURLANG.sm7, img: '<img src="/_assets/img/emoticons/cry.png" class="sm">', bbcode:":grandma:"},
				{title:CURLANG.sm8, img: '<img src="/_assets/img/emoticons/grin.png" class="sm">', bbcode:":grin:"},
				{title:CURLANG.sm9, img: '<img src="/_assets/img/emoticons/heart.png" class="sm">', bbcode:"<3"},
				{title:CURLANG.sm10, img: '<img src="/_assets/img/emoticons/heart.png" class="sm">', bbcode:":heart:"},
				{title:CURLANG.sm11, img: '<img src="/_assets/img/emoticons/joy.png" class="sm">', bbcode:":joy:"},
				{title:CURLANG.sm12, img: '<img src="/_assets/img/emoticons/kiss.png" class="sm">', bbcode:":*"},
				{title:CURLANG.sm13, img: '<img src="/_assets/img/emoticons/kiss.png" class="sm">', bbcode:":kiss:"},
				{title:CURLANG.sm14, img: '<img src="/_assets/img/emoticons/kissing_wink.png" class="sm">', bbcode:":kissing_wink:"},
				{title:CURLANG.sm15, img: '<img src="/_assets/img/emoticons/lock.png" class="sm">', bbcode:":lock:"},
				{title:CURLANG.sm16, img: '<img src="/_assets/img/emoticons/lol.png" class="sm">', bbcode:":lol:"},
				{title:CURLANG.sm17, img: '<img src="/_assets/img/emoticons/love.png" class="sm">', bbcode:":love:"},
				{title:CURLANG.sm18, img: '<img src="/_assets/img/emoticons/love_letter.png" class="sm">', bbcode:":love_letter:"},
				{title:CURLANG.sm19, img: '<img src="/_assets/img/emoticons/nerd.png" class="sm">', bbcode:":nerd:"},
				{title:CURLANG.sm20, img: '<img src="/_assets/img/emoticons/skull.png" class="sm">', bbcode:":skull:"},
				{title:CURLANG.sm21, img: '<img src="/_assets/img/emoticons/sleeping.png" class="sm">', bbcode:":sleeping:"},
				{title:CURLANG.sm22, img: '<img src="/_assets/img/emoticons/smile.png" class="sm">', bbcode:":)"},
				{title:CURLANG.sm23, img: '<img src="/_assets/img/emoticons/smile.png" class="sm">', bbcode:":smile:"},
				{title:CURLANG.sm24, img: '<img src="/_assets/img/emoticons/strawberry.png" class="sm">', bbcode:":strawberry:"},
				{title:CURLANG.sm25, img: '<img src="/_assets/img/emoticons/sunglasses.png" class="sm">', bbcode:":sunglasses:"},
				{title:CURLANG.sm26, img: '<img src="/_assets/img/emoticons/sweat_smile.png" class="sm">', bbcode:":sweat_smile:"},
				{title:CURLANG.sm27, img: '<img src="/_assets/img/emoticons/swedish.png" class="sm">', bbcode:":swedish:"},
				{title:CURLANG.sm29, img: '<img src="/_assets/img/emoticons/thinker.png" class="sm">', bbcode:":thinker:"},
				{title:CURLANG.sm29, img: '<img src="/_assets/img/emoticons/thumbs_up.png" class="sm">', bbcode:":thumbs_up:"},
				{title:CURLANG.sm30, img: '<img src="/_assets/img/emoticons/wink.png" class="sm">', bbcode:":wink:"},
				{title:CURLANG.sm31, img: '<img src="/_assets/img/emoticons/yum.png" class="sm">', bbcode:":yum:"},
				{title:CURLANG.sm32, img: '<img src="/_assets/img/emoticons/indian.png" class="sm">', bbcode:":indian:"},
				{title:CURLANG.sm33, img: '<img src="/_assets/img/emoticons/yum.png" class="sm">', bbcode:":P"},
				{title:CURLANG.sm34, img: '<img src="/_assets/img/emoticons/sad.png" class="sm">', bbcode:":sad:"},
				{title:CURLANG.sm35, img: '<img src="/_assets/img/emoticons/sad.png" class="sm">', bbcode:":("},
				{title:CURLANG.sm36, img: '<img src="/_assets/img/emoticons/ermm.png" class="sm">', bbcode:":ermm:"},
				{title:CURLANG.sm37, img: '<img src="/_assets/img/emoticons/awe.png" class="sm">', bbcode:":awe:"},
				{title:CURLANG.sm38, img: '<img src="/_assets/img/emoticons/grin.png" class="sm">', bbcode:":D"},
				{title:CURLANG.sm39, img: '<img src="/_assets/img/emoticons/cody.png" class="sm">', bbcode:":cody:"},
				{title:CURLANG.sm40, img: '<img src="/_assets/img/emoticons/ruie.png" class="sm">', bbcode:":ruie:"},
			],
	...
	$.wysibb.prototype = {
		...
		build: function() {
			...
			if (this.options.onlyBBmode===false) {
				...
				this.$body = $(this.strf('<div class="wysibb-text-editor" style="overflow-x: hidden; max-height:{maxheight}px;min-height:{height}px"></div>',{maxheight:mheight,height:height})).insertAfter(this.$txtArea);
