...
$(document).ready(function() {
  	...
  	$("body").on('click', '.spoilerheader', function() {
    	$(this).next(".spoilercontent").slideToggle(500);
	});
});
...
function signOut() {
	$.ajax({
	  url: urlRoute.getBaseUrl() + 'auth/logout',
	  type: 'get',
	  success: function(data) {
	      ...
	      urlRoute.ohSnap('<span class=\"alert-title\">Oh snap!</span><br />You have been logged out!', 'green');
	  }
	});
}
