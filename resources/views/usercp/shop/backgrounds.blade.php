...
<div class="reveal" id="background_you_sure" data-animation-in="fade-in" data-animation-out="fade-out" data-reveal>
    ...
    <div class="modal-body">
        Are you sure you want to buy the background <b id="BACKGROUND_NAME"></b> for <b id="BACKGROUND_PRICE"></b> credits?
    </div>
    <div class="modal-footer">
        <button class="pg-red headerRed gradualfader fullWidth shopbutton" onclick="buyBackground();">Buy <i class="fa fa-ticket" aria-hidden="true"></i></button>
