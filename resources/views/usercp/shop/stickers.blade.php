...
<div class="reveal" id="sticker_you_sure" data-animation-in="fade-in" data-animation-out="fade-out" data-reveal>
    ...
    <div class="modal-body">
        Are you sure you want to buy the icon <b id="STICKER_NAME"></b> for <b id="STICKER_PRICE"></b> credits?<br>
        <i id="STICKER_DESC"></i>
        <div class="small-centered" id="STICKER_PIC"></div>
    </div>
    <div class="modal-footer">
        <button class="pg-red headerRed gradualfader shopbutton fullWidth" onclick="buySticker();">Buy <i class="fa fa-ticket" aria-hidden="true"></i></button>
        <button id="close" class="pg-red headerBlue shopbutton fullWidth gradualfader" style="padding: 6px 12px;" data-close aria-label="Close modal" type="button">Close</button>
    </div>
</div>
