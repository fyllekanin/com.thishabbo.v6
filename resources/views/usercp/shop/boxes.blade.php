...
<div class="reveal" id="box_you_sure" data-animation-in="fade-in" data-animation-out="fade-out" data-reveal>
    ...
    <div class="modal-body">
        ...
        <i id="BOX_DESC"></i>
        <div class="small-centered" id="BOX_PIC">

        </div>
    </div>
    <div class="modal-footer">
        <button class="pg-red headerRed gradualfader fullWidth shopbutton" style="margin-top: 0.5rem;" onclick="buyBox();">Buy <i class="fa fa-ticket" aria-hidden="true"></i></button>
        <button id="close" class="pg-red headerBlue fullWidth gradualfader" style="padding: 6px 12px;" data-close aria-label="Close modal" type="button">Close</button>
    </div>
</div>
