<script>urlRoute.setTitle("TH - Followers List");</script>
	  		...
	  		<span>
				...
				<span>
					...
					<span>
						...
						<i class="fa fa-angle-double-right" aria-hidden="true"></i> Followers
					</span>
				</span>
			</span>
	    </div>
	...
	<div class="content-holder">
        <div class="content">
            <div class="contentHeader headerRed">
                <span>{!! $user['clean_username'] !!}'s Followers</span>
            </div>
            <div class="small-12">
                <table class="responsive" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>{{ $follower['habbo'] }}</td>
                        <td><button class="pg-red headerRed gradualfader topBottom" onclick='window.open("/profile/{!! $follower['clean_username'] !!}");' style="float:none !important;">Visit Profile</button></td>
                    </tr>
                    @endforeach
                </tbody></table>
            </div>
