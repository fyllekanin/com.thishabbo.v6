<script> urlRoute.setTitle("TH - Edit Clan Acolade");</script>
    ...
    <div class="content-holder">
        <div class="content">
            <div class="contentHeader headerRed">
                <span>Edit Accolade for {{ $groupname }}</span>
            </div>
...
<script type="text/javascript">
    var editAccolade = function() {
        ...
        $.ajax({
            url: urlRoute.getBaseUrl() + 'admincp/clans/accolade/edit',
            type: 'post',
            data: {accoladeid:accoladeid, display:display, accolade:accolade, groupid:groupid},
