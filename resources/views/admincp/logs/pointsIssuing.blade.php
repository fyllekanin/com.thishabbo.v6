<script> urlRoute.setTitle("TH - THC Issuing Log");</script>
    ...
    <div class="content-ct">
        <div class="small-12">
          ...
          <select class="login-form-input" id="action-id-filter">
            ...
            <option value="1" @if(isset($_GET['action']) && $_GET['action'] == 1) selected="selected" @endif>Added THC</option>
            <option value="2" @if(isset($_GET['action']) && $_GET['action'] == 2) selected="selected" @endif>Removed THC</option>
          </select>
          <br />
...
<script type="text/javascript">
  var filter = function() {
    ...
    urlRoute.loadPage('admincp/pointslogs/page/1'+name+action);
  }
